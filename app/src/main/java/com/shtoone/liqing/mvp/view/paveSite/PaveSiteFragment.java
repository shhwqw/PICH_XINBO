...
public class PaveSiteFragment extends BaseFragment<PaveSiteContract.Presenter> implements PaveSiteContract.View {
    @BindViews({R.id.cv_nianya, R.id.cv_pave_site,R.id.cv_pave_speed,R.id.cv_nianya_speed})
...
//    }
    ...
    @OnClick(R.id.cv_nianya_speed)
    void cv5OnClick(){
        startActivity(new Intent(_mActivity, RollingSpeedActivity.class));
    }
